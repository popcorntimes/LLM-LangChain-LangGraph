...
1. **Gerar a base de teste**: Cria o arquivo `base_clientes.csv` com 20 registros.

```bash
python gerar_base.py
```

2. **Processar as mensagens**: Executa o grafo e gera o `resultado_final_20.json`.
...
### Base Fake Robusta
Script `gerar_base.py` dedicado para gerar registros variados, cobrindo os cenários de teste exigidos.
